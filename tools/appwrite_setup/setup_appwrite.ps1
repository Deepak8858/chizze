...
appwrite databases create-datetime-attribute --database-id $DB --collection-id orders --key preparing_at --required false
appwrite databases create-datetime-attribute --database-id $DB --collection-id orders --key prepared_at --required false
appwrite databases create-datetime-attribute --database-id $DB --collection-id orders --key accepted_at --required false
