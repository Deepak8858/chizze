...
- [x] AOC-01: Admin API provides a way to preview stuck-order candidates with filters for status and age.
- [x] AOC-02: Admin API supports bulk hard deletion of eligible stuck orders and returns deleted/failed counts.
- [x] AOC-03: Cleanup API enforces safety guards so active in-progress statuses cannot be deleted.
- [x] AOC-04: Admin Orders UI exposes a guarded cleanup flow with explicit confirmation before deletion.
- [x] AOC-05: Automated backend and admin tests cover cleanup eligibility rules and deletion result reporting.
...
Last updated: 2026-04-03 after phase 2 execution completion
